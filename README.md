...
RtForksITCase requires additional parameter -Dfailsafe.github.organization=<organisation>
where <organization> is an organisation name to fork test github repository.
