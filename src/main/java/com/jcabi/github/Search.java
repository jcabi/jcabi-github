...
public interface Search {
     ...
     */
    Iterable<Repo> repos(String keywords, String sort, Search.Order order);
    ...
    Iterable<Issue> issues(
        ...
        String sort,
        Search.Order order,
        Map<Search.Qualifier, String> qualifiers);
     ...
     */
    Iterable<User> users(String keywords, String sort, Search.Order order);
     ...
     */
    Iterable<Content> codes(String keywords, String sort, Search.Order order);
